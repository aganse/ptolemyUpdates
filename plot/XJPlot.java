...
* Class:   XJPlot
*
* Purpose: Extended JPlot.  
*
* This class extends the JPlot plotting class (which is a Swing version
* of Berkley's Ptolemy PtPlot package).
*
* ---------------------------------------------------------------------
...
public class XJPlot extends JPlot implements MouseListener {
  ...
  */
  public double getDataY( int plotY ) {
      ...
      //return (double)(_uly - plotY)/_yscale + (double)_yMin;  //not right -AG
  }
 /**
  * Method:  getPlotX()
  *
